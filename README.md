...
<ol>
   ...
   <li>
    You must indicate the value for each parameter, e.g., if you would like to name your database as PRTR, you write ```--dn_name PRTR```. All arguments all           arguments except <code>--password</code> have a default value (see the table below)
